    ...
    <footer class="text-gray-500 bg-red-900 body-font">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <input class="w-40 sm:w-auto bg-gray-800 rounded text-white xl:mr-4 lg:mr-0 sm:mr-4 mr-2 border border-gray-700 focus:outline-none focus:border-indigo-500 text-base py-2 px-4" placeholder="Placeholder" type="text" />
